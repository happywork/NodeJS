define([
    ...
    function Engine() {
        ...
        /**
         * Event called when user opens Admin Setting page
         ...
         */
        self.ws.on('profit_company_updated', function(data) {
            self.trigger('profit_company_updated', data);
        });

        self.ws.on('customer_statistics_update', function(data) {
            self.trigger('customer_statistics_update', data);
        });
        ...
        self.ws.on('disconnect', function(data) {
            ...
            console.log('W: Disconnected |', data, '|', typeof data);
